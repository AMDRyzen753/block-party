...
/**
 * the handler class for the SimpleCloud Cloud-System
 *
 * @author TheRealDomm
 * @since 18.10.2021
 */
public class CloudHandler {
    ...
    public static void bootNextServer() {
        try {
            ...
            BlockPartyPlugin.getInstance().getLogger().info("Booted new Server!");
        } catch (Exception e) {
            BlockPartyPlugin.getInstance().getLogger().warning("CloudAPI not found! Ignoring it!");
        }
    }
    ...
    public static void sendPlayerToLobby(Player player) {
        ...
        try {
            ...
            if (iCloudPlayer != null) {
                String lobby = BlockPartyPlugin.getInstance().getMainConfig().getLobbyGroupName();
                ...
                BlockPartyPlugin.getInstance().getLogger().info("Moved " + player.getName() + " to lobby server!");
            } else {
                BlockPartyPlugin.getInstance().getLogger().warning("Player was not found! Could not move " +
